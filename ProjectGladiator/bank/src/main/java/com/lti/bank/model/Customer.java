...
public class Customer {
	...
	public Customer(String title, String emailId, String firstName, String middle_name, String lastName,
			String fatherName, long aadharNumber, String pancardNumber, String residentialAddress,
			String permanentAddress, long mobileNumber, String occupation_type, String sourceOfIncome,
			int grossAnnualIncome, int debitCard, int netBanking, Date dob, String gender) {
		super();
		this.title = title;
